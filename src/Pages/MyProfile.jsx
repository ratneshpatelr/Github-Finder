...
const MyProfile = () => {
  ...
  useEffect(() => {
    const apiCall = setTimeout(() => {
      axios.get("https://api.github.com/users/ratneshpatelr").then((res) => setData(res.data));
      axios.get("https://api.github.com/users/ratneshpatelr/repos").then((res) => setRepos(res.data));
    }, 1500);
  ...
  return (
    <>
      {/* Container */}
      <div className="items-center flex flex-col mb-5 px-5 h-auto bg-slate-500">
        {/* Page title */}
        <h1 className="text-4xl font-bold my-5 text-center text-black underline shadow-md">
          My GitHub Profile
        </h1>
